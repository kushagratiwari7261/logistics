    ...
    if (request.method === "OPTIONS") {
      return new Response(null, {
        headers: {
          ...
          "Access-Control-Allow-Headers": "Content-Type, Authorization, apikey, x-client-info, x-supabase-api-version, accept-profile, content-profile, prefer, range, x-upsert",
